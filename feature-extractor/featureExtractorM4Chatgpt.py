...
if __name__ == "__main__":
    ...
    df = pd.read_json('./arxiv_chatGPT.jsonl', lines=True)
    characters = [")", "-", ";", ":", "?", "'"]
    ...
    for df in df.itertuples():
        ...
        df1.to_csv('./features_chatgpt.csv', mode='a', index=False, header=header)
        header = False
    
    df = pd.read_csv('./features_chatgpt.csv')
    ...
    df.to_csv('./features_chatgpt_normalized.csv', index=False)
